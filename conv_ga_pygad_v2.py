...
def fitness_func(ga, solution, solution_idx):
    ...
    if num_kernel_conv1 == 0 or num_kernel_conv2 == 0 or kernel_size_pooling == 0:
...
for _ in range(sol_per_pop):
    individual = np.random.randint(2, size=87)
...
if __name__ == "__main__":
    ...
    ga_instance.save(f'/Users/katerina/Documents/GAoptimizedCNN/train_2nd/ga_instance.p')
    ...
    # Save the best model
    torch.save(best_model.state_dict(), f'/Users/katerina/Documents/GAoptimizedCNN/train_2nd/best_model.pth')
    ...
    plt.legend()
    plt.savefig(f'/Users/katerina/Documents/GAoptimizedCNN/train_2nd/final_best_model_accuracy.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig(f'/Users/katerina/Documents/GAoptimizedCNN/train_2nd/final_best_model_loss.png')
    plt.close()
